  ...
  return (
    <footer className="relative overflow-hidden bg-white text-neutral-900">
      ...
      <div
        ...
        style={{
          background:
            "repeating-linear-gradient(90deg, #fbbf24 0 28px, #ef4444 28px 56px, #3b82f6 56px 84px, #10b981 84px 112px)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14 md:px-10 md:py-16">
        ...
        <div className="grid gap-12 pb-12 md:grid-cols-4 md:gap-8">
          ...
          <FooterCol
            title="Coleção"
            links={["Álbum Oficial", "Envelopes", "Figurinhas Especiais", "Capa Dura"]}
          />
          <FooterCol
            title="Comunidade"
            links={["Trocas", "Ranking", "Eventos", "Discord"]}
          />
          <FooterCol
            title="Suporte"
            links={["Central de Ajuda", "Autenticidade", "Contato", "Termos"]}
          />
        </div>
